...
const CACHE = 'sp-shell-v20260919d';
const CORE = [
  './',
  './index.html',
  ...
  './icons/icon-192.png',
  './icons/icon-512.png',
  './css/styles.css?v=20260919d',
  './js/config.js?v=20260919d',
  './js/engine.js?v=20260919d',
  './js/store.js?v=20260919d',
  './js/ai.js?v=20260919d',
  './js/app.js?v=20260919d'
];
